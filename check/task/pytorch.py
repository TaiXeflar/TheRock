...
class PyTorch(BuildTasks):
    ...
    def __WINDOWS__(self):
        ...
        test_dict = {
            ...
            "CMake have CC":        device.CMake.post("COMPILER_VAR", "REQUIRED", lang="C", mode="REQUIRES", expected_compiler= device.llvm.info["LLVM Toolchain"]["clang"] ,fail_level="ERROR"),
            "CMake have CXX":       device.CMake.post("COMPILER_VAR", "REQUIRED", lang="C++", mode="REQUIRES", expected_compiler= device.llvm.info["LLVM Toolchain"]["clang++"] , fail_level="ERROR"),
            ...
            "LLVM Dist":            device.llvm.post("LLVM_DISTRIBUTION", "REQUIRED", configure="AMD-LLVM", fail_level="ERROR"),
            "ROCm Dist":            device.ROCm.post("ROCM_TYPE", "REQUIRED", ROCM_TYPE="TheRock", fail_level="ERROR"),
            "ROCm Library":         device.ROCm.post("roc-X", "REQUIRED", fail_level="ERROR", 
                                                     roc_X=["hip", "rocm-core", "amd_comgr", "hipRAND", "rocBLAS", 
                                                            "hipBLAS", "MIOpen", "hipFFT", "hipSPARSE", "rocPRIM",
                                                            "hipCUB", "rocThrust", "hipSOLVER", "rocSOLVER", "hiprtc",
                                                            "hipBLASLt", "hipSPARSELt"],
